...
<main>
  ...
  <div class="publishing">
    <div class="publish">
      ...
      <p>For information on eligibility and our journal publishing services and to submit a partnership request, <a href="http://blogs.cuit.columbia.edu/digitalpublishingworkshop/publish-with-us/">click here</a>.</p>
    </div>
    <div class="support">
    ...
    <ul class="menu">
      ...
      <li>
        <a href="https://journals.library.columbia.edu/index.php/cblr">
          <img src="{$baseUrl}/plugins/themes/journals-home/assets/logos/cblr.png" alt="">
      ...
      <li>
        <a href="https://journals.library.columbia.edu/index.php/cjel">
          <img src="{$baseUrl}/plugins/themes/journals-home/assets/logos/cjel.png" alt="">
          <h3>Columbia Journal of Environmental Law</h3>
        </a>
      </li>
      <li>
        <a href="https://journals.library.columbia.edu/index.php/cjgl">
          <img src="{$baseUrl}/plugins/themes/journals-home/assets/logos/cjgl.png" alt="">
