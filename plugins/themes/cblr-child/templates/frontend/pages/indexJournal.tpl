...
- adds cblr homepage cover image slider
...
<div id="main-content" class="page_index_journal" role="content">
  ...
  <div class="homepage-slideshow">
    ...
    <div class="csslider">
        ...
        <ul>
          <li class="cover">
            <img src="{$baseUrl}/plugins/themes/cblr-child/assets/slideshow-1.jpg" alt="">
          </li>
          <li>
            <img src="{$baseUrl}/plugins/themes/cblr-child/assets/slideshow-2.jpg" alt="">
          </li>
        </ul>
        <div class="arrows">
