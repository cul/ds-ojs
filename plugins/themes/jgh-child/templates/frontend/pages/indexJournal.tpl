...
<div id="main-content" class="page_index_journal" role="content">
  ...
  <div class="homepage-slideshow">
    ...
    <div class="csslider">
        ...
        <ul>
          <li class="cover">
            <img src="{$baseUrl}/plugins/themes/jgh-child/assets/jgh-1.jpg" alt="">
          </li>
          <li>
            <img src="{$baseUrl}/plugins/themes/jgh-child/assets/jgh-2.jpg" alt="">
          </li>
          <li>
            <img src="{$baseUrl}/plugins/themes/jgh-child/assets/jgh-3.jpg" alt="">
          </li>
          <li>
            <img src="{$baseUrl}/plugins/themes/jgh-child/assets/jgh-4.jpg" alt="">
          </li>
        </ul>
        <div class="arrows">
